...
def eval_detection_voc(pred_boxlists, gt_boxlists, iou_thresh=0.85):
...
def calc_detection_voc_prec_rec(gt_boxlists, pred_boxlists, iou_thresh=0.85):
...
def main():
    ...
    answer = pd.read_csv(options.answer)
